...
<div class="col-sm-5 mt-5" style="background-color :#D0D0D0 ;"> <!-- Start 3rd Column -->
    <form class="mx-5" action="" method="post">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="inputcode" name="usercode"  value="<?php if(isset($row['user_code'])){echo $row['user_code'];}?>">
        </div>
        </div>
        <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="inputmobile" name="usermobile" value="<?php if(isset($row['user_mobile'])){echo $row['user_mobile'];}?>">
        </div>
        </div>
        <div class="row">
        <div class="form-group col-md-6">
        ...
        <div class="float-right">
            ...
            <input type="reset" value="Reset" name="reset" class="btn btn-secondary shadow mt-3 ">
            </div>
    </form>
     <?php
        if(isset($msg))
