...
?>
     ...
     <div class="col-sm-9 mt-6 mx-5 class="col-sm-5 mt-5 style="background-color :#D0D0D0;" >
    ...
    if($_REQUEST['Id'] == "" || $_REQUEST['Name'] == "" || $_REQUEST['Email'] == ""){
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Id" placeholder="User Id" name="Id" value="<?php if(isset($row['Id'])){echo $row['Id'];}?>" readonly>
        </div>
        <div class="form-group">
